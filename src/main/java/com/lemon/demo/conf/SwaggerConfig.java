...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("DEMO REST API", "DEMO REST API.", "V1.0", "Terms of service",
				new Contact("demo", "http://www.baidu.com", "demo@demo.cn"), "License of API", "API license URL");
	}
	...
	SecurityConfiguration security() {
		return new SecurityConfiguration("test-app-client-id", "test-app-client-secret", "test-app-realm", "test-app",
				"Bearer ", ApiKeyVehicle.HEADER, "Authorization",
				"," /* scope separator */);
	}
